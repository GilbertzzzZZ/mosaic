...
> Timeline 把行数据渲染成纵向时间线：左侧状态圆点与贯穿竖线，右侧日期、标题、正文与负责人。它是六类区块中形态最简单的一个，设计重点在结构的自洽与渲染的宽容。用法见 [../timeline.md](../guides/timeline.md)。
...
- [../timeline.md](../guides/timeline.md)——用法与字段表
