# Code-block charts (`chartview`)

> Full reference for the `chartview` code-block entry: chart templates, the wizard, CSV loading, Dataview integration and interactions. Charts are rendered with [Ant Design Charts](https://charts.ant.design/).

- [Code-block charts (`chartview`)](#code-block-charts-chartview)
