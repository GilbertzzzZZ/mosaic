...
export async function parseConfig(content: string, plugin: MosaicPlugin, sourcePath: string): Promise<ChartProps> {
...
function customOptions(options: Options, plugin: MosaicPlugin): Options {
...
async function parseMultiViewConfig(dataProps: DataProps, data: DataType, options: Options, plugin: MosaicPlugin, sourcePath: string): Promise<Record<string, unknown>> {
...
async function loadFromFile(data: DataOptionType, plugin: MosaicPlugin, sourcePath: string, options: Options): Promise<DataType> {
...
async function loadFromDataViewPlugin(content: string, plugin: MosaicPlugin, sourcePath: string): Promise<DataType> {
...
async function loadFromMdWordCount(fileName: string, plugin: MosaicPlugin, options: Options): Promise<DataType> {
...
async function loadFromCsv(data: string, plugin: MosaicPlugin): Promise<DataType> {
